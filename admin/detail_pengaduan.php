  ...
  ?>
                  <div class="card-body">
                    ...
                    <div class="col-sm-12 col-md-7">
                      ...
                      <label><input type="radio" name="status" value="Belum dikonfirmasi" <?php if($row['status']=='Belum dikonfirmasi') echo 'checked'?> />
                      <div class="state p-primary-o"></label>
                        <label>Belum dikonfirmasi</label>
                      </div>
                    </div>
                    <div class="pretty p-default p-curve">
                      <label><input type="radio" name="status" value="Proses" <?php if($row['status']=='Proses') echo 'checked'?> /></label>
                      <div class="state p-primary-o">
                        <label>Proses</label>
                      </div>
                    </div><div class="pretty p-default p-curve">
                      <label><input type="radio" name="status" value="Selesai" <?php if($row['status']=='Selesai') echo 'checked'?> /></label>
                      <div class="state p-primary-o">
                        <label>Selesai</label>
                      </div>
                    </div>
