                  ...
                  <div class="card-body">
                    <div class="author-box-center">
                      ...
                      <div class="author-box-name">
                        <span style="color: blue;"><?php echo $_SESSION['nama']; ?></span>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <form method="POST">
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          <input type="text" class="form-control" value="<?php echo $_SESSION['nik']; ?>" readonly>
                        </div>
                      </div>
                      <div class="form-group">
                        <label>Nama Lengkap</label>
                        <div class="input-group">
                          <input id="name" type="text" class="form-control" name="nama_petugas" value="<?php echo $_SESSION['nama']; ?>" readonly>
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <span style="margin-top: 11px;font-size: 14px;color: #495057;">(+62)</span>&nbsp;
                          <input type="text" class="form-control" name="email" value="<?php echo $_SESSION['telp']; ?>" readonly>
                        </div>
                      </div>
                    </form>
                  </div>
